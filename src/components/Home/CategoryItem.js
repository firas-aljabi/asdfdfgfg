...
const CategoryItem = ({ category, lang, onClick }) => {
  return (
    <div className="focus-within:text-[#ab714d] ">
      <button
        className="sm:h-32 h-24 overflow-hidden focus-within:border-[#ab714d] bg-[#251c16] rounded-lg cursor-pointer text-[#C4C4C4] hover:border-[#ab714d] border-2 border-[#C4C4C4] transition duration-300 ease-in-out flex flex-col items-center justify-center w-full"
